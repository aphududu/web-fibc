...
<?php if ($params->get('greeting')) : ?>
	<li><?php echo JText::sprintf( 'HINAME', $user->get('name') ); ?><a href="<?php echo JRoute::_("index.php?option=com_user&task=logout&return=".base64_encode('index.php'));?>" class="logout-switch">
<?php endif; ?>
