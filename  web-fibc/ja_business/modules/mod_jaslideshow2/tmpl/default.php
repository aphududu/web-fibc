<div class="ja-slidewrap<?php echo $skin_name;?>" id="ja-slide-<?php echo $module->id;?>" style="visibility:hidden">
  ...
  <?php endif; ?>
  <div class="maskDesc"><div class="inner"><?php if (($showDescription=='desc' || $showDescription == 'desc-readmore') && $readmoretext!=''){?><a class="readon" title=""><span><?php echo $readmoretext;?></span></a><?php }?></div></div>
  </div>
