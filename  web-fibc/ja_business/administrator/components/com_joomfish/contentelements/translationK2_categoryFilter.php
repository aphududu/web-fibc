<?php
/**
 * @version		$Id: translationK2_categoryFilter.php 478 2010-06-16 16:11:42Z joomlaworks $
 * @package		K2
...
class translationK2_categoryFilter extends translationFilter {
    ...
    function _createfilterHTML() {
        ...
        $categoryOptions[] = JHTML::_('select.option', '-1', JText::_('Select category'));
        ...
        $catnameList = array();
        $catnameList["title"] = JText::_('Categories');
