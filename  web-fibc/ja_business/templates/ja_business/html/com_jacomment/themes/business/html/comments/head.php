...
//<![CDATA[	
	...
	var JACommentConfig = {
		...
		votedASC				: '<?php echo addslashes(JText::_("Most rated on top"));?>',
...
<?php }?>				
		...
		hidValidEmail			: '<?php echo JText::_("Your Email is invalid.");?>',
		...
		txtCopiedDecode			: '<?php echo JText::_("Copied DCODE");?>'							
	};																	
//]]>
</script>
