...
<?php if($typeDisplay == "onlyButton" && $display_comment_link):?>	
	<a class="jac_links jac-links<?php echo $id;?>" style="background: url('components/com_jacomment/asset/images/comment.png') no-repeat left center; padding-left: 16px;" href=<?php echo $links; ?> title="<?php echo JText::_('ADD COMMENT'); ?>"><?php echo JText::_('ADD COMMENT'); ?></a>	
<?php endif; ?>
