...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2LatestCommentsBlock <?php echo $params->get('moduleclass_sfx'); ?>">
	...
	<ul>	
		...
		<li class="<?php echo ($key%2) ? "odd" : "even"; if(count($comments)==$key+1) echo ' lastItem'; ?>">
			...
			<a class="lcComment-wrap" href="<?php echo $comment->link; ?>"><span class="lcComment"><?php echo $comment->commentText; ?></span></a>
			<?php else: ?>
			...
			<div class="userInfo clearfix">
				...
				<span class="lcCommentDate">
					...
					<?php else:?>
					<?php echo JText::_('on'); ?> <?php echo JHTML::_('date', $comment->commentDate, JText::_('DATE_FORMAT_LC4')); ?>
					<?php endif; ?>
				</span>
				<?php endif; ?>
			</div>
