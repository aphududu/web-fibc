  ...
  <div class="itemToolbar clearfix">
		<div class="itemMeta">
			...
			<span class="itemAuthor">
				<strong><?php echo JText::_('by: '); ?></strong>&nbsp;
			...
			<!-- Item category name -->
				<span class="itemCategory"><strong><?php echo JText::_('in: '); ?></strong>
				<a href="<?php echo $this->item->category->link; ?>"><?php echo $this->item->category->name; ?></a></span>
			<?php endif; ?>
  ...
  <div class="itemComments">
	  ...
	  <ul class="itemCommentsList">
	    ...
	    <li class="<?php echo ($key%2) ? "odd" : "even"; echo (!$this->item->created_by_alias && $comment->userID==$this->item->created_by) ? " authorResponse" : ""; ?>">
	    	...
	    	<span class="commentCount"><?php $commentCount +=1; echo $commentCount; ?></span>
			...
			<div class="userInfo clearfix">
				...
				<span class="commentDate"><?php echo JHTML::_('date', $comment->commentDate, JText::_('DATE_FORMAT_LC5')); ?></span>
