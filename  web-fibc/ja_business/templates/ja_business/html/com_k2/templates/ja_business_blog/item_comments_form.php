...
<form action="<?php echo JURI::root(); ?>index2.php" method="post" id="comment-form" class="form-validate">
	...
	<div class="formNameWrap clearfix">
		<label class="formName" for="userName"><?php echo JText::_( 'Name' ); ?> <span>*</span></label>
	...
	<div class="formNameWrap clearfix">
		<label class="formEmail" for="commentEmail"><?php echo JText::_( 'E-mail' ); ?> <span>*</span></label>
	...
	<div class="formUrlWrap clearfix">
